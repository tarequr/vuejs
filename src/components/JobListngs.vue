<script setup>
import jobData from "@/jobs.json"; // Assuming you have a jobs.json file with job listings
import { ref } from "vue";

const jobs = ref(jobData); // Load job data from JSON file
console.log(jobs.value.jobs); // For debugging purposes, you can see the loaded jobs in the console
</script>
